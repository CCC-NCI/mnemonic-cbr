...
@article{janetzko2025teaching,
  title={Dovetailing Case-Based Reasoning and Large Language Models to Compare Teaching Strategies: A Mnemonic Augmentation Framework using the EEDI Dataset},
